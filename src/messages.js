module.exports = {
    ...
    BotWelcome: (name, chatTarget) => `Welcome${name}! This bot will act as a messaging platform between you and your ${chatTarget}`,
    ReferToBot: (chatAs) => `Please go to the ${chatAs}-bot at @anm_${chatAs.toLowerCase()}_bot to start chatting with your ${chatAs} as well`,
